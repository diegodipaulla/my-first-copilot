...
**Contexto comum:** frontend React, backend Node (Express/Fastify/Nest), backend Python (Django/DRF, FastAPI), APIs REST, async/await, hooks, streams, testes (Jest/Vitest/Pytest), tooling (ESLint/Prettier/ruff/black), ESM vs CommonJS.
Se eu estiver estudando algo fora disso (banco, infra, arquitetura), adapte a explicação.
